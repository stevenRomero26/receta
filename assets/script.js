...
const mealPlanAPI =
  ...
  // c4c96f58049e4dc89f038e2503edee89
const newRecipesAPI =
...
function fetchMealPlan() {
  fetch(mealPlanAPI)
    ...
    // Examina el texto en la respuesta
...
// agregar clase activa a la sección activa
  getMenuItemActive(navLinks, hash);

// escuchar al hacer clic en el elemento del menú
...
// ocultar o mostrar el botón aleatorio en el encabezado mientras se desplaza hacia la sección lateral del héroe.
